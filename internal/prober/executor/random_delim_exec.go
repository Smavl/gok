...
type RandomDelimExecutor struct {}

func NewRandomDelimExecutor() *RandomDelimExecutor {
	return &RandomDelimExecutor{}
}
...
// TODO: Rework this to handle pty, \r, ansi escp codes and etc better!
